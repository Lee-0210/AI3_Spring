...
<body>
    ...
    <form action="<%= request.getContextPath() %>/request/check/person" 
          method="post">
        <div>
        	<label for="nameput">이름</label>
        	<input type="text" name="name" id="nameput"/>
        </div>
        <div>
        	<label for="ageput">나이</label>
        	<input type="text" name="age" id="ageput"/>
        </div>
    ...
    <form action="<%= request.getContextPath() %>/request/check/personDTO" 
        ...
        <div>
        	<label for="nameput">이름</label>
        	<input type="text" name="person.name" id="nameput"/>
        </div>
        <div>
        	<label for="ageput">나이</label>
        	<input type="text" name="person.age" id="ageput"/>
        </div>
        <div>
        	<label for="majorput">전공</label>
        	<input type="text" name="major" id="majorput"/>
        </div>
